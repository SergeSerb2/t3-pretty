 ...
 *
 * Fork: raised from the parent's 3 — this relay serves a handful of users, so
 * the cap only guards against runaway tunnel provisioning.
 */
export const DEFAULT_MANAGED_TUNNEL_LIMIT = 100;
