  ...
  return (
    <button
      ...
      className={cn(
        PULL_REQUEST_ROW_CLASS,
        PAGE_ROW_CLASS,
        "grid-cols-[auto_minmax(0,1fr)_auto] cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
    ...
    >
      ...
      <PullRequestRowLines
        ...
        metaClassName="@container/pr-row-meta overflow-hidden"
        meta={
          <>
            {matchedElsewhere ? (
              <Tooltip>
