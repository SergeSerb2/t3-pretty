...
function ComposerPromptEditorTiptapInner(props: ComposerPromptEditorProps) {
  ...
  const editorAttributes = useMemo(
    () => ({
      class: cn(
        "composer-tiptap -m-1 block max-h-52 min-h-19.5 w-full overflow-y-auto overscroll-contain p-1 whitespace-pre-wrap wrap-break-word bg-transparent leading-relaxed text-foreground focus:outline-none",
        className,
      ),
