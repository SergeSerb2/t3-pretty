        ...
        style={
          {
            ...
            // On macOS the traffic lights occupy more than the default 3rem
            // rail. Size the collapsed rail to the titlebar content inset
            // (right edge of the lights), not the lights' x-origin.
            "--workspace-titlebar-content-left":
              "calc(var(--workspace-controls-left, 0px) + var(--workspace-titlebar-control-size) + var(--workspace-titlebar-control-gap))",
            "--sidebar-width-icon": `max(${SIDEBAR_WIDTH_ICON}, var(--workspace-titlebar-content-left, 0px))`,
            ...style,
