...
export function BranchToolbarBranchSelector({
  ...
  const branchPrTooltip = branchPr
    ? `Open ${sourceControlPresentation.terminology.singular} #${branchPr.number} (${branchPr.state})${branchPrStatus?.automatedReview ? `. ${branchPrStatus.automatedReview.label}. ${branchPrStatus.automatedReview.description}` : ""}`
    : "";
