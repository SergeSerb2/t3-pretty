...
export interface CommandPaletteOpenIntent {
  readonly kind: "add-project" | "new-thread-in" | "new-canvas-in";
}
...
export function reduceCommandPaletteUiState(
  ...
  switch (action._tag) {
    ...
    case "OpenNewCanvasIn":
      return { open: true, mode: "command", openIntent: { kind: "new-canvas-in" } };
