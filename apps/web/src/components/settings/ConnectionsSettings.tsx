import { ChevronsLeftRightEllipsisIcon, PlusIcon, QrCodeIcon, RefreshCwIcon } from "lucide-react";
...
export function ConnectionsSettings() {
  ...
  const handleAddSavedBackend = useCallback(async () => {
    ...
    setIsAddingSavedBackend(false);
  }, [connectSshEnvironment, savedBackendSshHost, savedBackendSshPort, savedBackendSshUsername]);
    ...
    return (
      <>
        ...
        {desktopWslState.enabled ? (
          <SettingsRow
            title="WSL only"
            description="Stop the Windows backend and run only the WSL backend. Useful if you develop entirely inside WSL and don't want a second backend process. T3 Pretty restarts when you change this."
  ...
  return (
    <SettingsPageContainer>
      ...
      >
        {visibleSavedEnvironments.map((environment) => (
          <SavedBackendListRow
