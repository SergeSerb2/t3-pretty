...
function Shell({
  ...
  return (
    <div
      ...
      className={cn(
        "@container/composer-surface group/composer-surface relative z-0 mx-auto w-full max-w-3xl",
...
function ContextStrip({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/composer-context relative z-0 mx-auto -mt-4 flex w-[calc(100%-2*var(--chat-composer-drawer-inset))] items-center gap-2 overflow-x-clip overflow-y-visible ps-1 pe-2 pt-5 pb-1",
