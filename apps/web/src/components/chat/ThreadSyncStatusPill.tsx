...
export function ThreadSyncStatusPill({ phase }: { readonly phase: ThreadSyncPhase }) {
  ...
  return (
    <div
      aria-label={label}
      className="mount-rise-in chat-composer-drawer-surface chat-composer-drawer-attached chat-composer-drawer-slot pointer-events-none flex items-center gap-2 px-3 pt-2 pb-[calc(var(--chat-composer-attachment-overlap)_+_0.375rem)] text-foreground text-xs font-medium sm:px-4"
