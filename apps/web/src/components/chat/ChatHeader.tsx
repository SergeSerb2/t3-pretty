                ...
                <TooltipTrigger
                  render={
                    <button
                      ...
                      className="inline-flex min-w-0 max-w-full cursor-pointer items-center gap-1.5 rounded-sm text-muted-foreground/80 transition-colors hover:text-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring"
                    />
                  }
                >
        ...
        <WorkspaceBreadcrumbItem current className="min-w-10 flex-1">
          {renamingTitle !== null ? (
            <input
              ...
              className="min-w-0 flex-1 rounded-sm bg-transparent text-sm font-medium tracking-tight text-foreground outline-none ring-1 ring-ring/50 focus:ring-ring"
