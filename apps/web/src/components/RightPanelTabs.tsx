...
import { TitlebarLayoutControlsDragHole } from "./chat/PanelLayoutControls";
...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the T3 Pretty desktop app.",
        ...
        <div className="grid grid-cols-2 gap-2">
          {actions.map((action) =>
            action.available ? (
              ...
              <div
                key={action.label}
                className="group relative transition hover:-translate-y-0.5 active:translate-y-0"
    ...
    >
      <div
        className={cn(
          ...
          ownsDesktopTitleBar && "relative drag-region",
          ownsDesktopTitleBar &&
      ...
      >
        ...
        {props.layoutControls}
        {ownsDesktopTitleBar ? <TitlebarLayoutControlsDragHole controlCount={3} /> : null}
      </div>
