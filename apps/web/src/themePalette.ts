...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  canvas: "#fdf7fd",
  // T3 Pretty's workspace header belongs to the chat panel, so keep it seamless
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  // Diffs and file previews are full workspace surfaces in T3 Pretty. Keep them
...
/**
 * The palette T3 Pretty wears with no theme installed, captured from the app's
...
/**
 * The standard T3 Pretty look as a theme palette, for seeding a new theme when
...
/**
 * The status colors T3 Pretty shows without a theme, read from the app's own
