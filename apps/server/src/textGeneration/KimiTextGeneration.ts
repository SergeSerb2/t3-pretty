...
/**
 * Build a Kimi text-generation closure bound to a specific `KimiSettings`
  ...
  const runKimiJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const promptResult = yield* Effect.gen(function* () {
        yield* runtime.start();
        yield* Effect.ignore(runtime.setMode("yolo"));
            ...
            new TextGenerationError({
              ...
              detail:
                step === "set-config-option"
                  ...
                  : "Failed to set Kimi ACP base model for text generation.",
              cause,
            }),
        });
          ...
          Option.match({
            onNone: () =>
              Effect.fail(
                new TextGenerationError({
                  operation,
                  detail: "Kimi Code request timed out.",
                }),
              ),
        ...
        return yield* new TextGenerationError({
          ...
          detail:
            promptResult.stopReason === "cancelled"
              ...
              : "Kimi Code returned empty output.",
        });
      }
        ...
        Effect.catchTags({
          SchemaError: (cause) =>
            Effect.fail(
              new TextGenerationError({
                operation,
                detail: "Kimi Code returned invalid structured output.",
                cause,
              }),
            ),
        }),
