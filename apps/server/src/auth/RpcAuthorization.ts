...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.issuesConnections]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesConnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesDisconnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesMetadata]: AuthOrchestrationReadScope,
