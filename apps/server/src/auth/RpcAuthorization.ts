...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.canvasGet]: AuthOrchestrationReadScope,
  [WS_METHODS.canvasApply]: AuthOrchestrationOperateScope,
  [WS_METHODS.canvasUpdateSelection]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscribeCanvasEvents]: AuthOrchestrationReadScope,
