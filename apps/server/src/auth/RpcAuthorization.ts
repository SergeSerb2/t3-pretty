...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.threadSecretRequestRespond]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.appsSetToken]: AuthOrchestrationOperateScope,
  [WS_METHODS.appsSetOAuthClient]: AuthOrchestrationOperateScope,
  [WS_METHODS.appsDisconnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.appsTest]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.storageGetInventory]: AuthOrchestrationReadScope,
  [WS_METHODS.storageStreamInventory]: AuthOrchestrationReadScope,
  [WS_METHODS.storageRemoveOrphan]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.automationsGetRun]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.projectTransfersSend]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectTransfersCancel]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.homeSuggestionsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.homeSuggestionsRefresh]: AuthOrchestrationOperateScope,
  [WS_METHODS.homeSuggestionsDismiss]: AuthOrchestrationOperateScope,
  [WS_METHODS.subscribeHomeSuggestions]: AuthOrchestrationReadScope,
