...
const firstPromptResponseText = process.env.T3_ACP_FIRST_PROMPT_RESPONSE_TEXT;
...
let currentModeId = emulateKimi || antigravityProfile ? "default" : "ask";
let currentModelId = emulateKimi
  ? "kimi-code/k3"
  : antigravityProfile
    ? "gemini-test-low"
    : "default";
      ...
      yield* agent.client.sessionUpdate({
        ...
        update: {
          ...
          content: {
            type: "text",
            text:
              (promptCount === 1 ? firstPromptResponseText : undefined) ??
              promptResponseText ??
              "hello from mock",
          },
        },
