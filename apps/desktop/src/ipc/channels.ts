...
export const EDIT_CONTEXT_MENU_CHANNEL = "desktop:edit-context-menu";
export const RESOLVE_EDIT_CONTEXT_MENU_CHANNEL = "desktop:resolve-edit-context-menu";
...
export const PREVIEW_CAPTURE_TAB_IMAGE_CHANNEL = "desktop:preview-capture-tab-image";
...
export const CAPTURE_GET_PERMISSION_STATUS_CHANNEL = "desktop:capture-get-permission-status";
export const CAPTURE_LIST_SOURCES_CHANNEL = "desktop:capture-list-sources";
export const CAPTURE_SOURCE_CHANNEL = "desktop:capture-source";
