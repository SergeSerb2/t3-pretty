...
export const CLI_RUNTIME_EXTERNAL_PREFIXES = [
  ...
  "sharp",
  "@img/",
  // sharp 0.35 requires detect-libc at runtime. An external sharp cannot
  // resolve a bundled-away detect-libc from the real filesystem (WSL
  // MODULE_NOT_FOUND, same class as the old msgpackr-extract miss).
  "detect-libc",
