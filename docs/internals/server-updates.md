...
that launcher requires a local service update using T3 Pretty's release package:

```sh
npx --yes --package https://pub-8033bcab5baf492b81c605581ff028e0.r2.dev/t3-pretty/latest/t3-<version>.tgz t3 service update
```

The command stops the unit, selects the new launcher and exact runtime, then
