...
The agent runtime T3 Code controls to perform work. Seven drivers ship built in: Codex, Claude, Cursor, Grok, Grok Bot, Kimi, and Antigravity. See [ProviderService.ts][14], [ProviderAdapter.ts][15], and [CodexAdapter.ts][17] as a representative adapter.
