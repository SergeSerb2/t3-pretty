...
- A new thread opens in fog over the assigned place, then clears with the location name
  settling above the chat box along with the photo credit. Scrolling up through a thread
  hides that credit; returning to the latest messages brings it back.
